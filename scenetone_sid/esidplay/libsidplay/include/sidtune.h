...
//	bool saveToOpenFile( ofstream& toFile, ubyte* buffer, udword bufLen ); //ALFRED - TODO
...
//	virtual bool PSID_fileSupportSave(ofstream& toFile, ubyte* dataBuffer); //ALFRED - TODO
...
//	virtual bool SID_fileSupportSave(ofstream& toFile);  //ALFRED - TODO
